...
export default defineConfig({
  ...
  themeConfig: {
      ...
      "/shumono/": [
        {
          ...
          items: [
            ...
            {
              text: "间章第5话",
              link: "/shumono/draft/interlogue-5.md",
            },
          ],
        },
      ],
    ...
    footer: {
      message:
        '<a href="https://beian.miit.gov.cn/" target="_blank">京ICP备2025131681号</a>',
      copyright:
        'Copyright © 2025 <a href="https://github.com/ConstasJ" target="_blank">ConstasJ</a> | 本网站一切原创内容按照 <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh-hans" target="_blank">CC BY-NC-SA 4.0</a> 授权',
    },
  },
});
